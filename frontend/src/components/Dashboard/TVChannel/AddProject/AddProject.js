                    ...
                    <Card.Body>
                        ...
                        <Form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Form.Group controlId="managerName">
                                ...
                                <Form.Control type="text" placeholder="Enter Manager name" name="managerName" ref={register({ required: true, maxLength: 80 })} />
                            </Form.Group>

                            <Form.Group controlId="channelAddress">
                                <Form.Label>Address</Form.Label>
                                <Form.Control type="text" placeholder="Address" name="channelAddress" ref={register({ required: true, maxLength: 400 })} />
                            </Form.Group>
