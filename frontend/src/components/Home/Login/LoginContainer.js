...
const LoginContainer = props => {
    ...
    return (
        <div>
            ...
            <Button variant="info" onClick={() => { auth.login(() => { bypassLogin(props, 'channelOwner') }); }}>ByPass Admin Login</Button>{' '} &nbsp;&nbsp;
            <Button variant="info" onClick={() => { auth.login(() => { bypassLogin(props, 'brandOwner') }); }}>ByPass Consumer Login</Button>{' '}
